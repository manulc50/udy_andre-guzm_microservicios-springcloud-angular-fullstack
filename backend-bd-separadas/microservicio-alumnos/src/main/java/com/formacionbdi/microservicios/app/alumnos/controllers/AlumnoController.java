...
public class AlumnoController extends CommonController<Alumno,AlumnoService>{
	...
	public ResponseEntity<Iterable<Alumno>> obtenerAlumnosPorCurso(@RequestParam List<Long> ids){
		return ResponseEntity.ok().body(this.service.findAllById(ids));
	}
	...
	public ResponseEntity<List<Alumno>> filtrar(@PathVariable(value="term") String termino){
		return ResponseEntity.ok().body(this.service.findByNombreOrApellidos(termino));
	}
