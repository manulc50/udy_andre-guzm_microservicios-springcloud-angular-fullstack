...
public class ExamenController extends CommonController<Examen,ExamenService>{
	...
	public ResponseEntity<Iterable<Long>> obtenersExamenesIdsPorPreguntasIds(@RequestParam List<Long> preguntaIds){
		return ResponseEntity.ok().body(this.service.findExamenesIdsByPreguntaIds(preguntaIds));
	}
}
